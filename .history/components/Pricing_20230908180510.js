            ...
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <div className="flex flex-col w-full justify-center mb-8 flex-none mt-12">
                  ...
                  <ButtonOutline onClick={() => { console.log("Button clicked"); 
                  window.location.href = "https://cosmofeed.com/vp/64fb0070241d10001ea571ea";
                  }}>
                    Select</ButtonOutline>
                </div>
              </motion.div>
            </ScrollAnimationWrapper>
            <ScrollAnimationWrapper className="flex justify-center">
              ...
              >
                ...
                <ul className="flex flex-col list-inside pl-6 xl:pl-0 items-start justify-start text-left text-black-500 flex-grow">
                  <li className="relative check custom-list my-2">
                    150 Lve + Recorded Classes, in app learning
                  </li>
                  <li className="relative check custom-list my-2">
                  ...
                  <li className="relative check custom-list my-2">
                    45 Days Placemet Camp, Placement Assurance 
                  </li>
                  <li className="relative check custom-list my-2">
